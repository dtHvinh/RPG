...
public class EnemyState : EntityState
{
    ...
    public override void UpdateAnimationParameters()
    {
        ...
        Animator.SetFloat(AnimatorConstants.BATTLE_ANIM_SPEED_MULTI, enemy.Movement.BattleAnimSpeedMulti);
        Animator.SetFloat(AnimatorConstants.MOVE_ANIM_SPEED_MULTI, enemy.Movement.MoveAnimSpeedMulti);
    }
}
